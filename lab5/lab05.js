...
function showWindowHref(){
    ...
    document.getElementById("url-result").value=GetQueryString();
}
...
let mul = document.getElementById("mul");let i=0;
...
function arrSameStr(){
    ...
    var Obj={};     //定义一个空对象
                ...
                result.value='The most character is:'+char+' times:'+num;
